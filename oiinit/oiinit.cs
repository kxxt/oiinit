...
namespace oiinit
{
	static class Program
	{
		...
		static Program()
		{
			...
			try
			{
				env = System.AppDomain.CurrentDomain.BaseDirectory;

				bin = env + "oiinit_bin" + dsgn;
				//MessageBox.Show(endl + "\r\n" + env + "\r\n" + bin);
		...
		private static void ShowSplash()
		{
			...
			Output(ConsoleColor.Black, ConsoleColor.Yellow, "You are running this app on " + ((Environment.OSVersion.Platform == PlatformID.Win32NT) ? "Windows" : "non-Windows OS") + "\r\n");
		}
